...
export const posts: BlogPost[] = [
  {
    slug: "who-pays-what-when-moving-in-together",
    title: "Who Pays What When You Move In Together?",
    description: "The money talk nobody wants to have — but everyone needs to. Here's how couples actually split rent, bills, and shared expenses without the fights.",
    date: "2026-03-18",
...
**1. 50/50 down the middle**
Everything is divided equally. Rent, utilities, groceries, Netflix. Simple, clean, and feels fair on paper.
...
Each partner pays a percentage of shared costs that matches their share of combined income. If you earn 60% of the household income, you pay 60% of shared expenses.
...
**3. Designated bills**
Partner A pays rent. Partner B pays utilities and groceries. Total amounts are roughly balanced.
...
**Ready to create yours?** Our [free cohabitation agreement generator](/) walks you through it in about 5 minutes. Free and easy to use.
  ...
  {
    slug: "what-happens-to-stuff-when-we-break-up",
    title: "What Happens to Our Stuff If We Break Up?",
    description: "From the couch you bought together to the dog you both love, here's what actually happens to shared property when unmarried couples split.",
    date: "2026-03-14",
...
**[Create your free cohabitation agreement →](/)** It takes about 5 minutes and covers all of the above.
  ...
  {
    slug: "moving-in-together-checklist",
    title: "The Moving In Together Checklist Most Couples Skip",
    description: "Most couples check off the logistics — lease, furniture, utilities. Almost none of them cover the five conversations that actually predict relationship success.",
    date: "2026-03-10",
...
Questions to answer:
- How much advance notice do you need before the other person brings friends over?
- Do you have a shared workspace, and what are the rules?
- How do you signal when you need alone time without it becoming a rejection?
...
**The document that covers the conversations:**
Our [free cohabitation agreement generator](/) takes you through all five conversation areas step by step and produces a ready-to-sign document in about 5 minutes.
    `.trim(),
  },
  {
    slug: "common-cohabitation-conflicts-and-how-to-prevent-them",
    title: "The 6 Most Common Cohabitation Conflicts (and How to Prevent Each One)",
    description: "These six conflicts appear in almost every cohabitating relationship. Here's why they happen and exactly what to put in writing to prevent them.",
    date: "2026-03-05",
...
**[Start your free cohabitation agreement →](/)** It covers finances, property, guest expectations, separation terms, and more. Takes about 5 minutes.
  ...
  {
    slug: "do-unmarried-couples-need-a-cohabitation-agreement",
    title: "Do Unmarried Couples Actually Need a Cohabitation Agreement?",
    description: "The honest answer — including who benefits most, what these agreements actually do, and why most couples wait until it's too late.",
    date: "2026-02-28",
    readingTime: "5 min read",
    category: "Legal",
    content: `
...
**[Create your agreement now →](/)**
  ...
  },
  {
    ...
    title: "How to Split Rent Fairly When You Earn Different Amounts",
    description: "50/50 isn't always fair. Here are the three most common rent-splitting models, the math behind each one, and how to pick the one that works for your relationship.",
    date: "2026-02-20",
...
**The formula**:
- Partner A income: $60,000 → 60% of combined
- Partner B income: $40,000 → 40% of combined
- Total rent: $2,400
- Partner A pays: $1,440 | Partner B pays: $960
...
**[Document your rent split in a cohabitation agreement →](/)** Our free generator covers rent, utilities, shared expenses, and everything else in about 5 minutes.
  ...
  {
    slug: "my-boyfriend-wont-talk-about-money",
    title: "My Boyfriend Refuses to Talk About Money — and We Move In Next Month",
    description: "A girlfriend writes in about her partner shutting down every financial conversation before their big move. Sound familiar?",
    date: "2026-03-25",
    readingTime: "5 min read",
    category: "Money",
    content: `
...
**[Start the conversation with our free agreement generator →](/)** It walks through everything — finances, property, separation terms — and gives you a document you both sign. No awkward confrontation needed.
  ...
  {
    slug: "her-family-keeps-staying-with-us",
    title: "Her Family Keeps Staying With Us and I Can't Take It Anymore",
    description: "A boyfriend writes in about his girlfriend's family treating their apartment like a hotel — and the conversation they've never had about boundaries.",
    date: "2026-03-24",
    readingTime: "5 min read",
    category: "Conflict",
    content: `
...
**[Add guest policies to your cohabitation agreement →](/)** Our free generator includes a dedicated section for visitor expectations.
  ...
  {
    slug: "different-cleanliness-standards-driving-us-apart",
    title: "We Have Completely Different Cleanliness Standards and It's Ruining Us",
    description: "A partner writes in about the slow, grinding conflict that happens when one person's 'clean enough' is the other person's breaking point.",
    date: "2026-03-23",
    readingTime: "6 min read",
    category: "Conflict",
    content: `
...
|------|-------|-----------|
| Kitchen cleanup after dinner | Alternating nightly | Daily |
| Bathroom cleaning | Partner B | Weekly (Saturday) |
| Vacuuming/sweeping | Partner A | Weekly (Sunday) |
| Trash and recycling | Partner B | As needed, min 2x/week |
| Laundry (personal) | Each person | Own schedule |
| Grocery shopping | Alternating | Weekly |
...
**[Build a chore plan into your cohabitation agreement →](/)** Our free generator includes a household responsibilities section that makes this conversation concrete.
  ...
  {
    slug: "not-on-the-lease-no-rights",
    title: "I've Been Paying Rent for a Year but My Name Isn't on the Lease",
    description: "A girlfriend discovers that 12 months of rent payments don't give her any legal claim to the apartment she calls home.",
    date: "2026-03-22",
    readingTime: "5 min read",
    category: "Legal",
    content: `
...
### 1. Get on the lease
Ask your boyfriend to add you. If the landlord allows it, this gives you equal legal standing. If he resists, that tells you something about the power dynamic.

### 2. Create a cohabitation agreement
If getting on the lease isn't possible (some landlords won't allow it, or the lease terms prevent it), a cohabitation agreement can document:
...
Every Venmo payment. Every text about rent. Every conversation about the apartment as "ours." If this ever becomes a dispute, documentation is your strongest asset.
...
**[Protect yourself with a free cohabitation agreement →](/)** It covers housing rights, financial contributions, notice requirements, and separation terms. Takes about 5 minutes.
  ...
  {
    slug: "we-adopted-a-dog-together-now-what",
    title: "We Adopted a Dog Together — What Happens If We Break Up?",
    description: "A boyfriend writes in about the pet they adopted as a couple and the legal nightmare waiting if they don't plan ahead.",
    date: "2026-03-21",
    readingTime: "5 min read",
    category: "Property",
    content: `
...
That means:
- **Whoever's name is on the adoption paperwork is the legal owner.** Period.
- **It doesn't matter who paid for food, vet bills, or daily care.** Financial contribution doesn't create ownership rights for property.
- **Verbal agreements ("he's both of ours") are essentially unenforceable** without written documentation.
...
- **Joint ownership declaration**: Both partners acknowledge shared ownership regardless of whose name is on the adoption form.
- **Financial contributions**: Document who pays for what — vet bills, food, insurance, grooming.
- **Primary caretaker designation**: Who handles daily walks, feeding, and vet appointments.
- **Separation plan**: If the relationship ends, what happens? Options include:
  - One partner keeps the pet with visitation for the other
  - Alternating custody (week on, week off)
  - One partner keeps the pet and reimburses the other for their financial contributions
...
**[Add a pet agreement to your cohabitation plan →](/)** Our free generator includes a dedicated pet section covering ownership, expenses, and separation terms.
  ...
  {
    slug: "working-from-home-space-conflict",
    title: "I Work From Home and My Partner Doesn't Get Why I Need Space",
    description: "A partner writes in about the daily tension of remote work in a shared apartment — and why 'just use the kitchen table' isn't a real solution.",
    date: "2026-03-20",
    readingTime: "5 min read",
    category: "Planning",
    content: `
...
**[Document your space and expense arrangement →](/)** Our free cohabitation agreement generator covers workspace, expense splits, and household responsibilities.
  ...
  {
    slug: "he-moved-in-and-took-over",
    title: "He Moved Into My Apartment and Now Acts Like He Owns the Place",
    description: "A girlfriend writes in about the slow, uncomfortable shift that happens when your partner moves into your space — and starts changing everything.",
    date: "2026-03-19",
    readingTime: "5 min read",
    category: "Property",
    content: `
...
Common patterns:
- **Furniture and decor get replaced or pushed aside** without discussion
- **Storage space quietly shifts** toward the newer occupant's belongings
- **Shared spaces get claimed** for individual use (gaming setups, craft stations, workout equipment)
- **The original occupant starts asking permission** to change things in their own home

## The conversation framework

This needs to happen now, before the resentment calcifies:

### 1. Acknowledge the asymmetry
You moved in first. This is your home that you're generously sharing. That doesn't mean your partner is a guest — but it does mean major changes to the space require mutual agreement, not unilateral action.

### 2. Define shared vs. personal space
- Which areas are truly shared (living room, kitchen)?
- Which areas does each person have primary control over?
- What changes require a conversation vs. what's fair game?

### 3. Set a "change request" norm
Any alteration that affects shared space — furniture moves, new items, reorganization — gets discussed first. Not vetoed, discussed. This isn't controlling. It's respectful.

### 4. Document the ownership reality
If you owned furniture, appliances, or decor before your partner moved in, those items remain yours. This matters enormously if the relationship ends. A cohabitation agreement should list pre-existing property for each partner.
...
These are questions a cohabitation agreement answers clearly:
- **Rent contribution does not equal ownership** of the apartment or its contents
- **Pre-existing furnishings remain the property** of the original occupant
- **Shared purchases are documented** so there's no dispute later
- **Move-out terms are defined** — including restoring the space to its prior state
...
**[Create your cohabitation agreement →](/)** It covers property ownership, shared space norms, and what happens if the arrangement changes. About 5 minutes.
  ...
  {
    slug: "bought-furniture-together-now-breaking-up",
    title: "We Bought Everything Together — Now We're Breaking Up",
    description: "A boyfriend writes in mid-breakup, realizing that thousands of dollars of shared purchases have no clear owner.",
    date: "2026-03-17",
    readingTime: "6 min read",
    category: "Property",
    content: `
...
List every shared item. Be exhaustive. Include approximate purchase price and current estimated value.

### Step 2: Categorize
- **Clearly one person's**: They owned it before the relationship, or it's primarily personal (their clothes, their books). This goes with that person.
- **Clearly shared**: Bought together for the shared home. These need to be divided.
- **Disputed**: One person claims it, the other disagrees.

### Step 3: Alternate picks
For shared items, take turns choosing. Partner A picks an item, then Partner B, and so on. This isn't perfect, but it's faster and less acrimonious than negotiating each item individually.

### Step 4: Buyout option
If one person wants an item the other also wants, they can "buy out" the other partner's share at half the current estimated value. The TV is worth roughly $600 now? Pay your ex $300 and keep it.

### Step 5: Sell and split
Items neither person wants (or both want but can't agree on) get sold, and the proceeds are divided equally.
...
**[Create your cohabitation agreement before you need it →](/)** Our free generator includes a shared property section with a built-in division framework. Five minutes now saves weeks of arguments later.
  ...
  {
    slug: "partner-spends-money-we-dont-have",
    title: "My Partner's Spending Is Out of Control and It's Affecting Both of Us",
    description: "A partner writes in about the stress of watching shared finances drain because of one person's spending habits — and having no agreement to fall back on.",
    date: "2026-03-15",
    readingTime: "5 min read",
    category: "Money",
    content: `
...
- **No withdrawal rules**: Either partner can pull money for any reason
- **No minimum balance requirement**: The account can be drained to zero before rent is due
- **No accountability mechanism**: "I'll make it up" is a promise, not a system
- **Personal spending mixed with shared obligations**: The line between "our money" and "my money" disappears

## What your financial agreement should include

### 1. Account purpose and restrictions
The shared account is for: rent, utilities, groceries, household supplies. It is NOT for: personal purchases, gifts, entertainment, or anything that isn't a shared household expense.

### 2. Minimum balance rule
The account balance should never drop below one month's rent. If it does, the partner who caused the shortfall is responsible for replenishing it within a defined timeframe.

### 3. Withdrawal notifications
Any withdrawal over a set amount (say $50 or $100) that isn't a recurring household bill requires a heads-up to the other partner. Not permission — notification.

### 4. Personal spending boundaries
Each person's individual spending from their personal accounts is their own business. But personal spending cannot cause shared obligations to go unmet. If your half of the bills is $1,500 and you have $1,600 in your account, the concert tickets wait.

### 5. Review schedule
Monthly check-in: Is the deposit amount still right? Are all shared expenses being covered? Do the rules need adjusting?
...
**[Set up your financial agreement →](/)** Our free cohabitation agreement generator includes detailed financial sections — shared accounts, personal spending, emergency funds, and what happens if someone can't pay.
  ...
  {
    slug: "he-doesnt-do-any-housework",
    title: "I Do Everything Around the House and He Doesn't Even Notice",
    description: "A girlfriend writes in about the invisible labor problem — and why asking for help isn't the same as having a fair system.",
    date: "2026-03-13",
    readingTime: "6 min read",
    category: "Conflict",
    content: `
...
**[Build your household responsibility plan →](/)** Our free cohabitation agreement generator includes a complete chore and responsibility section. It takes 5 minutes — and it might save your relationship.
  ...
  {
    slug: "im-scared-to-bring-up-a-cohabitation-agreement",
    title: "I Want a Cohabitation Agreement but I'm Scared My Partner Will Think I Don't Trust Them",
    description: "A partner writes in about the fear that asking for a written agreement will damage the relationship — and why the opposite is almost always true.",
    date: "2026-03-11",
    readingTime: "5 min read",
    category: "Legal",
    content: `
...
In any case, their refusal doesn't prevent you from protecting yourself. You can still:
- Keep records of all financial contributions
- Maintain your own documentation of shared purchases
- Ensure your name is on the lease and key accounts
